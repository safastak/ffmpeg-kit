...
#include <stdbit.h>
#else
// C23 stdbit.h fallback for older compilers
#define stdc_count_ones(value) __builtin_popcountll((unsigned long long)(value))
#define stdc_trailing_zeros(value) __builtin_ctzll((unsigned long long)(value))
#endif
