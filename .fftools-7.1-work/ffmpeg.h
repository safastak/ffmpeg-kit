 ...
 * - "class" member field renamed as clazz in OutputStream, OutputFile, OutputFilter, FilterGraph,
 *   Decoder, InputStream, InputFile
 * - __thread added to global extern variables for concurrent execution
 * - set_report_callback and cancel_operation declared
 * - const OptionDef options[] declaration removed (options defined inline in ffmpeg_execute)
 *
 * 07.2023
 * --------------------------------------------------------
