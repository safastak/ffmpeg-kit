 ...
 * - ffprobe_options used instead of options
 * - real_options removed
 * - show_help_default renamed as show_help_default_ffprobe
 *
 * mobile-ffmpeg / ffmpeg-kit changes by Taner Sener
 *
 * 09.2022
 * --------------------------------------------------------
 * - volatile keyword dropped from thread local variables
 *
 * 01.2020
 * --------------------------------------------------------
 * - ffprobe support merged into ffmpeg-kit
 * - main method renamed as ffprobe_execute
 * - exit_program updated with longjmp, discarding exit
 * - AV_LOG_STDERR log level introduced
 *
 * 12.2019
 * --------------------------------------------------------
 * - concurrent execution support ("__thread" specifier added to global variables)
 */
...
__thread int do_show_stream_groups = 0;
__thread int do_show_stream_group_components = 0;
__thread int do_show_streams = 0;
__thread int do_show_stream_disposition = 0;
__thread int do_show_stream_group_disposition = 0;
...
__thread int do_show_stream_group_tags = 0;
...
{
    show_usage();
    show_help_options(ffprobe_options, "Main options:", 0, 0);
...
int ffprobe_execute(int argc, char **argv)
{
    ...
    ret = parse_options(NULL, argc, argv, ffprobe_options, opt_input_file);
    if (ret < 0) {
